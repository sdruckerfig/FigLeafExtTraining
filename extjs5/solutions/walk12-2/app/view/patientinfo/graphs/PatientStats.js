/**
 * Grid control for displaying 
 * patient height/weight/bp/bmi telemetry
 */
...
Ext.define('PatientChart.view.patientinfo.graphs.PatientStats', {
    ...
    /**
     * @event addrecord
     * Firing this event indicates that a record should be added to the grid
     * @param {Ext.panel.Panel} panel The Panel object
     */

     /**
     * @event delrecord
     * Firing this event indicates that the currently selected record should
